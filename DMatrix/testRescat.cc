...
//   TGraph* gArgandS=new TGraph(nsteps);
  ...
  for(unsigned int i=0;i<nsteps;++i){
    ...
    std::cout << "eps and rho calculated" << std::endl;
    ...
    std::cout << "after modPhi" << std::endl;
    std::cout.flush();
...
//     cout << lambda11 << endl;
    ...
    double phi1,phi2,m1;
    gA1RhoPhi->GetPoint(is,m1,phi1);
    gA1EpsPhi->GetPoint(is,m1,phi2);

    gA1DPhi->SetPoint(is,m1,phi2-phi1);
